<template>
	<div>
		<meta-head title="Update Student Details" />
		<!-- breadcrumb -->
		<nav class="py-4" aria-label="breadcrumb">
			<ol class="flex leading-none text-indigo-600 divide-x divide-indigo-400 font-bold text-2xl">
				<li class="pr-4">
					<inertia-link :href="route('admin.students.show', student.grade_id)">
				...
				<div class="space-y-6">
					<div class="grid grid-cols-1 md:grid-cols-2 gap-20 gap-y-8">
						...
						<div>
							...
							<select v-model="form.grade_id" id="grade_id" class="appearance-none form-input" required>
...
export default {
	...
	methods: {
		update() {
			this.form.post(this.route('admin.students.update', this.student.id))
		},
	},
}

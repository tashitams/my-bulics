				...
				<div class="space-y-6">
					<div class="grid grid-cols-1 gap-20 gap-y-8">
						...
						<div>
							...
							<input v-model="form.event_date" type="date" placeholder="Select from date" class="form-input" :class="{ 'has-error': errors.event_date }" id="event_date" required />
...
export default {
	...
	methods: {
		update() {
			this.form.post(this.route('admin.events.update', this.event.id))
		},
	},
}
